\cleardoublepage
\setdaydateyear{TOREPLACE_WSDAY}{TOREPLACE_WSDATE}{TOREPLACE_WSYEAR}
\chapter[Workshops: \daydate]{Workshops}
\thispagestyle{emptyheader}
\setheaders{Workshops}{\daydateyear}
\vfill

\input{content/workshops/TOREPLACE_TIMEZONE/overview}
\afterpage{\null\newpage}
\newpage
\clearpage
...
\begin{wsschedule}
    ...
    {workshop1}
    {\WShopLocA}
    \input{auto/WiNLP/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop2}
    {\WShopLocB}
    \input{auto/iwslt/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop3}
    {\WShopLocC}
    \input{auto/NLP4ConvAI/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop4}
    {\WShopLocD}
    \input{auto/BioNLP2020/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop5}
    {\WShopLocE}
    \input{auto/FEVER/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop6}
    {\WShopLocF}
    \input{auto/iwpt/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop7}
    {\WShopLocG}
    \input{auto/flp/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop8}
    {\WShopLocH}
    \input{auto/nuse/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop9}
    {\WShopLocI}
    \input{auto/alvr/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop10}
    {\WShopLocJ}
    \input{auto/RepL4NLP/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop11}
    {\WShopLocK}
    \input{auto/nli/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop12}
    {\WShopLocL}
    \input{auto/wngt/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop13}
    {\WShopLocM}
    \input{auto/bea/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop14}
    {\WShopLocN}
    \input{auto/SIGMORPHON/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop15}
    {\WShopLocO}
    \input{auto/nlpmc/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop16}
    {\WShopLocP}
    \input{auto/ecnlp/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop17}
    {\WShopLocQ}
    \input{auto/SocialNLP/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop18}
    {\WShopLocR}
    \input{auto/AutoSimTrans/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
...
\begin{wsschedule}
    ...
    {workshop19}
    {\WShopLocS}
    \input{auto/Challenge-HML/TOREPLACE_TIMEZONE/schedule}
\end{wsschedule}
